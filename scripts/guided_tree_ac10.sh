...
params_filename=results/agents/ppo_async/${num_g}gen/params.json #results/tmp/params.json 
env_params_filename=results/agents/ppo_async/${num_g}gen/env_params.json #src/ts4uc_scripts/data/day_ahead/${num_g}gen/30min/env_params.json
policy_filename=results/agents/ppo_async/${num_g}gen/ac_final.pt #results/tmp/ac_final.pt
horizon=2
branching_threshold=0.05
tree_search_func_name=uniform_cost_search
testfile=data/day_ahead/${num_g}gen/30min/profile_2019-11-09.csv
