...
save_dir=results/final_results/raw_agents/${agent}/${num_gen}gen/test_${num_files}/$seed
...
python src/tree_search_utils/tests/multiple_day_ahead_raw_agent.py --save_dir $save_dir \
