...
env_params_filename=results/agents/qlearning/env_params.json #src/ts4uc_scripts/data/day_ahead/${num_g}gen/30min/env_params.json
policy_filename=results/agents/qlearning/agent.pt #results/tmp/ac_final.pt
horizon=2
